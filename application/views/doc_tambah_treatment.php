...
<head>
   ...
   <title>Waja - Tambah Treatment</title>
   <!-- Bootstrap css -->
...
<body class="bg-light">
   <div class="change-profile d-flex flex-column vh-100">
      ...
      <div class="d-flex align-items-center justify-content-between mb-auto p-3 bg-white shadow-sm osahan-header">
         <a href="<?= base_url() . "dokter/pasien?a=" . $id_pasien ?>" class="text-dark bg-white shadow rounded-circle icon">
            <span class="mdi mdi-arrow-left mdi-18px"></span></a>
         <h6 class="mb-0 ms-3 me-auto fw-bold">Treatment Baru</h6>
      ...
      <div class="vh-100 my-auto overflow-auto p-3">
         <form method="post" action="<?= base_url() . 'Dokter/simpanTreatment' ?>">
            <div class="mb-3">
               ...
               <div class="input-group border bg-white rounded-3 py-1" id="exampleFormControlName1">
                  ...
                  <input required name="tanggal" type="date" class="form-control bg-transparent rounded-0 border-0 px-0" placeholder="dd/mm/yyyy" aria-label="Type your last name" aria-describedby="firstname">
               </div>
            </div>
