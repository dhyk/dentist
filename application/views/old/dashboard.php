      ...
      <div class="row">
        ...
        <br />
          <a href="<?= base_url() . 'pengumuman_baru' ?>">
            ...
            <button class="btn btn-primary" style="width:100%">Buat Pengumuman Baru</button>
          </a>
        </div>
      </div>
    </div>
          ...
          <div class="card-body">
            <div class="media static-widget">
              <div class="media-body">
                <h6 class="font-roboto">Pengumuman</h6>
                <h4 class="mb-0 counter"><?= $all ?></h4>
              </div>
              <h1 class="txt-primary"><i class="icofont icofont-social-rss"> </i></h1>
            ...
            <div class="progress-widget">
              <div class="progress sm-progress-bar progress-animate">
                <div class="progress-gradient-primary" role="progressbar" style="width: 100%" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"><span class="animate-circle"></span></div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="col-sm-6 col-xl-3 col-lg-6">
        <div class="card o-hidden">
          <div class="card-body">
            <div class="media static-widget">
              <div class="media-body">
                <h6 class="font-roboto">Terkirim</h6>
                <h4 class="mb-0 counter"><?= $terkirim ?></h4>
              </div>
              <h1 class="txt-success"><i class="icofont icofont-send-mail"> </i></h1>
            ...
            <div class="progress-widget">
              <div class="progress sm-progress-bar progress-animate">
                <div class="progress-gradient-success" role="progressbar" style="width: 100%" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"><span class="animate-circle"></span></div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="col-sm-6 col-xl-3 col-lg-6">
        <div class="card o-hidden">
          <div class="card-body">
            <div class="media static-widget">
              <div class="media-body">
                <h6 class="font-roboto">Draft</h6>
                <h4 class="mb-0 counter"><?= $aktif ?></h4>
              </div>
              <h1 class="txt-warning"><i class="icofont icofont-ui-text-loading"> </i></h1>
            ...
            <div class="progress-widget">
              <div class="progress sm-progress-bar progress-animate">
                <div class="progress-gradient-secondary" role="progressbar" style="width: 50%" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"><span class="animate-circle"></span></div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="col-sm-6 col-xl-3 col-lg-6">
        <div class="card o-hidden">
          <div class="card-body">
            <div class="media static-widget">
              <div class="media-body">
                <h6 class="font-roboto">Gagal</h6>
                <h4 class="mb-0 counter"><?= $gagal ?></h4>
              </div>
              <h1 class="txt-danger"><i class="icofont icofont-ui-close"> </i></h1>
            ...
            <div class="progress-widget">
              <div class="progress sm-progress-bar progress-animate">
                <div class="progress-gradient-danger" role="progressbar" style="width: 30%" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"><span class="animate-circle"></span></div>
              </div>
            </div>
          </div>
        </div>
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                      ...
                      <td><?= $key->judul ?></td>
                      <td>
                        <span class="txt-primary"><i class="icofont icofont-ui-user"></i>200</span>
                        <span class="txt-success"><i class="icofont icofont-ui-check"></i>10</span>
                        <span class="txt-danger"><i class="icofont icofont-ui-close"></i>5</span>
                      </td>
                    </tr>
                  <?php
                  }
