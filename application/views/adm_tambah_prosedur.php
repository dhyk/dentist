...
<head>
   ...
   <title>Waja - Tambah Data Prosedur</title>
   <!-- Bootstrap css -->
...
<body class="bg-light">
   <div class="change-profile d-flex flex-column vh-100">
      ...
      <div class="d-flex align-items-center justify-content-between mb-auto p-3 bg-white shadow-sm osahan-header">
         ...
         <h6 class="mb-0 ms-3 me-auto fw-bold">Prosedur Baru</h6>
      ...
      <div class="vh-100 my-auto overflow-auto p-3">
         <form method="post" action="<?= base_url() . 'Admin/simpanprosedur' ?>">
            <div class="mb-3">
               <label for="exampleFormControlName" class="form-label mb-1">Prosedur</label>
               <div class="input-group border bg-white rounded-3 py-1" id="exampleFormControlName">
                  ...
                  <input required name="prosedur" type="text" class="form-control bg-transparent rounded-0 border-0 px-0" placeholder="Tuliskan prosedur" aria-label="Type your first name" aria-describedby="firstname">
               </div>
            </div>
