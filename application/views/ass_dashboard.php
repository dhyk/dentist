         ...
         <div class="px-3 pb-3">
            <!-- <form> -->
               <!-- <div class="input-group rounded-4 shadow overflow-hidden border-0 py-1 ps-3 bg-light"> -->
                 ...
                 <a href="<?= base_url().'Assistant/tambahbiodata' ?>">
                  <button class="btn btn-info form-control bg-transparent border-0 px-3 fs-14">Tambah Pasien</button>
                 </a>
                  <!-- </div> -->
            <!-- </form> -->
         </div>
      ...
      <div class="vh-100 my-auto overflow-auto body-fix-osahan-footer">
         <div class="py-3">
            ...
            <div>
              ...
              ?>
               <!-- 1st -->
               <a href="<?= base_url() . "assistant/pasien?a=".$key->id_pasien ?>" class="link-dark">
