   ...
   <div class="select-area d-flex flex-column vh-100">
      <div class="bg-white shadow-sm">
         <div class="d-flex align-items-center justify-content-between mb-auto p-3 osahan-header">
            <div class="d-flex align-items-center gap-2 me-auto">
               ...
               <h6 class="mb-0 ms-3 me-auto fw-bold">Data BHP</h6>
            </div>
         ...
         <div class="px-3 pb-3">
            <a href="<?= base_url() . 'Admin/tambahbhp' ?>">
               <button class="btn btn-info form-control bg-transparent border-0 px-3 fs-14">Tambah BHP</button>
            </a>
      ...
      <div class="vh-100 my-auto overflow-auto body-fix-osahan-footer">
         <div class="py-3">
            <!-- Specialist -->
            <div>
               <h6 class="mb-2 pb-1 px-3 fw-bold text-black">BHP</h6>

               <?php
               foreach ($bhp as $key) {
               ?>
                  <!-- 1st -->
                  <a href="<?= base_url() . "admin/bhpdetail?a=" . $key->id_bhp ?>" class="link-dark">
                     <div class="d-flex align-items-center gap-3 bg-white border-bottom shadow-sm p-3">
                        <div class="small">
                           <h6 class="mb-1 fs-14"><?= $key->bhp ?></h6>
                        </div>
                     </div>
                  </a>
                  <!-- 2nd -->
