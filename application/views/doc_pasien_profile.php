   ...
   <div class="doctor-profile d-flex flex-column vh-100">
            ...
            <div class="tab-content" id="pills-tabContent">
               ...
               <div class="tab-pane fade p-3" id="pills-experience" role="tabpanel" aria-labelledby="pills-experience-tab" tabindex="0">
                  ...
                  <div class="bg-white rounded-4 p-3 mb-3 shadow-sm">
                     ...
                     <div class="footer d-grid mt-auto p-3">
                        <div class="d-flex gap-2">
                           <a href="call-doctor.html" class="btn btn-xs btn-outline-info bg-light btn-lg col"><i class="bi bi-pencil me-2"></i> Ubah Treatment</a>
                  ...
                  <div class="bg-white rounded-4 p-3 mb-3 shadow-sm">
                     ...
                     <div class="footer d-grid mt-auto p-3">
                        <div class="d-flex gap-2">
                           <a href="<?= base_url().'dokter/ubahtreatment'?>" class="btn btn-xs btn-outline-info bg-light btn-lg col"><i class="bi bi-pencil me-2"></i> Ubah Treatment</a>
                           <!-- <a href="request-appointment.html" class="btn btn-xs btn-info btn-lg col">Ubah Treatment</a> -->
                        </div>
                     </div>
                  </div>
      ...
      <div class="footer d-grid mt-auto p-3">
         <div class="d-flex gap-2">
            ...
            <a href="<?= base_url().'dokter/tambahtreatment' ?>" class="btn btn-info btn-lg col">Treatment Baru</a>
         </div>
      </div>
   </div>
   <!-- share offcanvas -->
