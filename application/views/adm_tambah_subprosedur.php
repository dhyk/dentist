...
<head>
   ...
   <title>Waja - Tambah Data Sub Prosedur</title>
   <!-- Bootstrap css -->
...
<body class="bg-light">
   <div class="change-profile d-flex flex-column vh-100">
      ...
      <div class="d-flex align-items-center justify-content-between mb-auto p-3 bg-white shadow-sm osahan-header">
         <a href="<?= base_url() . 'Admin/prosedur_detail?a='.$id_prosedur ?>" class="text-dark bg-white shadow rounded-circle icon">
            <span class="mdi mdi-arrow-left mdi-18px"></span></a>
         <h6 class="mb-0 ms-3 me-auto fw-bold">Sub Prosedur Baru</h6>
      ...
      <div class="vh-100 my-auto overflow-auto p-3">
         <form method="post" action="<?= base_url() . 'Admin/simpansubprosedur' ?>">
            <div class="mb-3">
               <label for="exampleFormControlName" class="form-label mb-1">Sub Prosedur</label>
               <div class="input-group border bg-white rounded-3 py-1" id="exampleFormControlName">
                  ...
                  <input required name="subprosedur" type="text" class="form-control bg-transparent rounded-0 border-0 px-0" placeholder="Tuliskan sub prosedur" aria-label="Type your first name" aria-describedby="firstname">
                  <input type="hidden" name="id_prosedur" value="<?= $id_prosedur?>" />
               </div>
            </div>
