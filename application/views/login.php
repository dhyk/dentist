   ...
   <div class="sign-in p-4">
      <div class="d-flex align-items-start justify-content-between mb-4">
         <div>
            ...
            <p class="text-muted mb-0">Selamat datang,<br>silahkan masuk!</p>
         </div>
      ...
      <form>
         ...
         <div class="mb-3">
            ...
            <div class="input-group border bg-white rounded-3 py-1" id="exampleFormControlPassword">
               ...
               <input type="password" class="form-control bg-transparent rounded-0 border-0 px-0"
                  placeholder="Type your password" aria-label="Type your password" aria-describedby="password"
                  value="123456789">
            </div>
         </div>
         ...
         <div>
            <a href="<?= base_url()."home/ceklogin" ?>" class="btn btn-info btn-lg w-100 rounded-4 mb-2">Masuk</a>
