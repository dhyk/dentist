...
<body class="bg-light">
   <div class="change-profile d-flex flex-column vh-100">
      ...
      <div class="d-flex align-items-center justify-content-between mb-auto p-3 bg-white shadow-sm osahan-header">
         <a href="<?= base_url() . "assistant/pasien?a=" . $pasien->id_pasien ?>" class="text-dark bg-white shadow rounded-circle icon">
      ...
      <div class="vh-100 my-auto overflow-auto p-3">
         <form method="post" action="<?= base_url() . 'Assistant/editbiodata' ?>">
            <div class="mb-3">
               ...
               <div class="input-group border bg-white rounded-3 py-1" id="exampleFormControlName">
                  ...
                  <input value="<?= $pasien->nama ?>" required name="nama" type="text" class="form-control bg-transparent rounded-0 border-0 px-0" placeholder="Tuliskan nama pasien" aria-label="Type your first name" aria-describedby="firstname">
               </div>
            </div>
            <div class="mb-3">
               ...
               <div class="input-group border bg-white rounded-3 py-1" id="exampleFormControlName1">
                  ...
                  <input value="<?= $pasien->lahir ?>" required name="lahir" type="date" class="form-control bg-transparent rounded-0 border-0 px-0" placeholder="dd/mm/yyyy" aria-label="Type your last name" aria-describedby="firstname">
               </div>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
               ...
               <div class="input-group border bg-white rounded-3 py-1" id="exampleFormControlName1">
                  ...
                  <input value="<?= $pasien->alamat ?>" required name="alamat" type="text" class="form-control bg-transparent rounded-0 border-0 px-0" placeholder="Tuliskan alamat pasien" aria-label="Type your last name" aria-describedby="firstname">
               </div>
            </div>
            ...
            <div class="mb-3">
               ...
               <div class="input-group border bg-white rounded-3 py-1" id="exampleFormControlName1">
                  ...
                  <input value="<?= $pasien->pekerjaan ?>" required name="pekerjaan" type="text" class="form-control bg-transparent rounded-0 border-0 px-0" placeholder="Tuliskan pekerjaan pasien" aria-label="Type your last name" aria-describedby="firstname">
               </div>
            </div>
            ...
            <div>
               ...
               <div class="input-group border bg-white rounded-3 py-1" id="exampleFormControlNumber">
                  ...
                  <input value="<?= $pasien->wa ?>" required name="wa" type="text" class="form-control bg-transparent rounded-0 border-0 px-0" placeholder="+62" aria-label="Type your number" aria-describedby="number">
               </div>
            </div>
            ...
            <div class="mb-3">
               ...
               <div class="input-group border bg-white rounded-3 py-1" id="exampleFormControlName1">
                  ...
                  <textarea required name="alergi" type="text" class="form-control bg-transparent rounded-0 border-0 px-0" placeholder="Tuliskan alergi dari pasien" aria-label="Type your last name" aria-describedby="firstname"><?= $pasien->alergi ?></textarea>
               </div>
            </div>
            ...
            <div class="mb-3">
               ...
               <div class="input-group border bg-white rounded-3 py-1" id="exampleFormControlName1">
                  ...
                  <textarea required name="riwayat" type="text" class="form-control bg-transparent rounded-0 border-0 px-0" placeholder="Tuliskan riwayat kesehatan pasien" aria-label="Type your last name" aria-describedby="firstname"><?= $pasien->riwayat ?></textarea>
               </div>
            </div>
