...
<head>
   ...
   <title>Waja - Tambah Data Sub BHP</title>
   <!-- Bootstrap css -->
...
<body class="bg-light">
   <div class="change-profile d-flex flex-column vh-100">
      ...
      <div class="d-flex align-items-center justify-content-between mb-auto p-3 bg-white shadow-sm osahan-header">
         <a href="<?= base_url() . 'Admin/bhpdetail?a='.$id_bhp ?>" class="text-dark bg-white shadow rounded-circle icon">
            <span class="mdi mdi-arrow-left mdi-18px"></span></a>
         <h6 class="mb-0 ms-3 me-auto fw-bold">Sub BHP Baru</h6>
      ...
      <div class="vh-100 my-auto overflow-auto p-3">
         <form method="post" action="<?= base_url() . 'Admin/simpansubbhp' ?>">
            <div class="mb-3">
               <label for="exampleFormControlName" class="form-label mb-1">Sub BHP</label>
               <div class="input-group border bg-white rounded-3 py-1" id="exampleFormControlName">
                  ...
                  <input required name="subbhp" type="text" class="form-control bg-transparent rounded-0 border-0 px-0" placeholder="Tuliskan sub BHP" aria-label="Type your first name" aria-describedby="firstname">
                  <input type="hidden" name="id_bhp" value="<?= $id_bhp?>" />
               </div>
            </div>

            <div class="mb-3">
               <label for="exampleFormControlName" class="form-label mb-1">Harga</label>
               <div class="input-group border bg-white rounded-3 py-1" id="exampleFormControlName">
                  <span class="input-group-text bg-transparent rounded-0 border-0" id="firstname">
                     <span class="mdi mdi-debug-step-over mdi-18px"></span>
                  </span>
                  <input required name="harga" type="number" class="form-control bg-transparent rounded-0 border-0 px-0" placeholder="Tuliskan harga" aria-label="Type your first name" aria-describedby="firstname">
