...
<body class="bg-light">
   <div class="doctor-profile d-flex flex-column vh-100">
      <div class="d-flex align-items-center justify-content-between mb-auto p-3 bg-white shadow-sm osahan-header">
         <a href="<?= base_url() . 'Admin' ?>" class="text-dark bg-white shadow rounded-circle icon">
                           ...
                           <div class="card card-body">
                              ...
                              <div class="footer d-grid mt-auto p-3">
                                 <div class="d-flex gap-2">
                                    <a href="<?= base_url() . 'admin/printbill?a=' . $key->id_treatment ?>" class="btn btn-xs btn-outline-info bg-light btn-lg col"><i class="bi bi-printer me-2"></i> Print Bill</a>
